    ...
    (function (e) {
        ...
        var a, c, u, l, h, f, p = (a = (o = function () {
            ...
            return t = e, o = [{
                ...
                value: function (e) {
                    var t, n;
                    1 !== e.button && (n = e.delegateTarget, this.parser.href = n.getAttribute("href"), t = "", "/" !== this.parser.pathname[0] && (t = "/"), e = this.origin + t + this.parser.pathname + this.parser.search + this.parser.hash, t = "true" === n.getAttribute("data-prevent"), n = "true" === n.getAttribute("data-popin"), history.pushState({
                        prevented: t,
                        popin: n
                    }, null, e))
                }
